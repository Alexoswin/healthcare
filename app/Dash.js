...
export default function Dashboard({navigation}) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Messages')} style={styles.box1}>
          <Text style={{ fontSize: 15 }}  > 
            Messages
          </Text>
          <Text style={{ fontSize: 24 }} >
      ...
      <TouchableOpacity onPress={() => navigation.navigate('AddPatients')} style={styles.box1}> 
          <Text   style={{ fontSize: 15 }} > 
            Add new Patient
          </Text>
      </TouchableOpacity>
      ...
      <View style={styles.container5 } >
        <Text style={{fontSize: 20}}>Upcommig Appointments</Text>
        <View style={styles.box2}>
          <Text onPress={()=> navigator.navigate("AddPatients")} style={{fontSize: 18}}>Patient Name</Text> 
          <Text>Date: 5/5/25</Text>
          <Text>Time: 6:30 pm</Text> 
